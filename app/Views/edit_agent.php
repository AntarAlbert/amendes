    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header text-primary">
                MODIFICATION AGENT BENEFICIAIRE
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                echo form_dropdown('division_id', $options, $agent_obj['division_id'], $js); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                echo form_dropdown('id_recapitulatif', $options, $agent_obj['id_recapitulatif'], $js); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
