        ...
        <div class="container mt-5">
            <div class="card">
                <div class="card-header text-prnum_pvary">
                    AJOUT NOUVELLE AMENDE
                </div>
                <div class="card-body">
                    <form method="post" id="add_amende" name="add_amende" action="<?= site_url('/add-amende') ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                echo form_dropdown('id_lieu_redaction', $options, set_value('id_lieu_redaction'), $js); ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                ...
                                echo form_dropdown('id_autorite_requerente', $options, set_value('id_autorite_requerente'), $js); ?>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                echo form_dropdown('id_reglementation', $options, set_value('id_reglementation'), $js); ?>
                                </div>
                            </div>
                            <div class="col-md-10">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                $data = [
                                    ...
                                    'id'       => 'montant_penalite',
                                    'value'    =>  set_value('montant_penalite'),
                                    'required' => true,
                                    'class' => 'form-control',
